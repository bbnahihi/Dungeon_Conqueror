...
public class CollisionChecker {
    ...
    public void checkTile(Entity entity) {
        ...
        boolean projectile = entity instanceof Bullet;

        if (gp.isNormalBackgroundMapActive()) {
            if (gp.collidesWithMapCollision(worldHitbox, projectile)) {
        ...
        if (gp.collidesWithNormalMapObstacle(worldHitbox, projectile)) {
            entity.collisionOn = true;
        }
    }
    ...
    public boolean checkWallCollision(int targetX, int targetY, Rectangle hitbox) {
        ...
        if (gp.isNormalBackgroundMapActive()) {
            return gp.collidesWithMapCollision(worldHitbox, true);
        }
